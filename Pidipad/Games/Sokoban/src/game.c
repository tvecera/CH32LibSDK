...
// tile character and color
const u8 TileChar[TILE_NUM*2] = {
	0,	COL_BLACK,	// EMPTY = 0,	// 0: empty (grass)
	1,	COL_RED,	// WALL,	// 1: wall
	2,	COL_GRAY,	// FLOOR,	// 2: floor
	3,	COL_BLUE,	// MARK,	// 3: mark
	4,	COL_YELLOW,	// CRATE,	// 4: crate
	5,	COL_GREEN,	// FULL,	// 5: full crate (crate on mark)
	9,	COL_WHITE,	// FACE,	// 6: face
	9,	COL_CYAN,	// FACE_MARK,	// 7: face on mark
};
...
void DispTile(u8 x, u8 y)
{
	...
	PrintCharAt(TileChar[tile*2], x, y, TileChar[tile*2+1]);
}	
