...
// game map
#define STEP		4		// base step size, in number of pixels
...
#define BOARDW		(MAPW*STEP) // board total width (= 160)
#define BOARDX		((WIDTH-BOARDW)/2) // board X coordinate (= 0)
#define BOARDH 		((MAPH+HEADH)*STEP) // board total height (= 100)
#define BOARDY 		((HEIGHT-BOARDH)/2) // board Y coordinate (= 10)
