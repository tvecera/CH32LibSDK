...
INLINE void USART1_Init(int baud, int wordlen, int parity, int stop) { USARTx_Init(USART1, wordlen, baud, parity, stop); }
INLINE void USART2_Init(int baud, int wordlen, int parity, int stop) { USARTx_Init(USART2, wordlen, baud, parity, stop); }
INLINE void USART3_Init(int baud, int wordlen, int parity, int stop) { USARTx_Init(USART3, wordlen, baud, parity, stop); }
INLINE void USART4_Init(int baud, int wordlen, int parity, int stop) { USARTx_Init(USART4, wordlen, baud, parity, stop); }
