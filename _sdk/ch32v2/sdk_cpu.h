...
INLINE void di(void)
{
	__asm volatile (" csrc 0x800,%0\n" :: "r" (0x88) : "memory");
	isb();
}

// enable global interrupts
INLINE void ei(void) { __asm volatile (" csrs 0x800,%0\n" :: "r" (0x88) : "memory"); }

// get global interrupts (returns True if interrupts are enabled)
INLINE Bool geti(void)
{
	u32 val;
	__asm volatile (" csrr %0, 0x800\n" : "=r" (val) :: "memory");
	return (val & B3) != 0;
}
...
// Get floating-point flags
INLINE u32 get_FFLAGS(void)
{
	u32 res;
	__asm volatile(" csrr %0, fflags\n": "=r" (res));
	return res;
}

// Set floating-point flags
INLINE void set_FFLAGS(u32 val)
{
	__asm volatile(" csrw fflags, %0\n" : : "r" (val));
}

// Get floating-point dynamic rounding mode
INLINE u32 get_FRM(void)
{
	u32 res;
	__asm volatile(" csrr %0, frm\n": "=r" (res));
	return res;
}

// Set floating-point dynamic rounding mode
INLINE void set_FRM(u32 val)
{
	__asm volatile(" csrw frm, %0\n" : : "r" (val));
}

// Get floating-point control and status register
INLINE u32 get_FCSR(void)
{
	u32 res;
	__asm volatile(" csrr %0, fcsr\n": "=r" (res));
	return res;
}

// Set floating-point control and status register
INLINE void set_FCSR(u32 val)
{
...
// Get machine trap value register
INLINE u32 get_MTVAL(void)
{
	u32 res;
...
// Set machine trap value register
INLINE void set_MTVAL(u32 val)
{
...
// atomic ADD 32-bit, returns original value
INLINE s32 amoadd(volatile s32* addr, s32 val)
{
	s32 res;
	__asm volatile(" amoadd.w %0, %2, %1\n" : "=r" (res), "+A" (*addr) : "r" (val) : "memory");
	return res;
}

// atomic AND 32-bit, returns original value
INLINE u32 amoand(volatile u32* addr, u32 val)
{
	u32 res;
...
// atomic OR 32-bit, returns original value
INLINE u32 amoor(volatile u32* addr, u32 val)
{
	u32 res;
...
// atomic XOR 32-bit, returns original value
INLINE u32 amoxor(volatile u32* addr, u32 val)
{
	u32 res;
...
// atomic SWAP 32-bit, returns original value
INLINE u32 amoswap(volatile u32* addr, u32 val)
{
	u32 res;
...
// atomic MAX signed 32-bit, returns original value
INLINE s32 amomax(volatile s32* addr, s32 val)
{
	s32 res;
...
// atomic MAX unsigned 32-bit, returns original value
INLINE u32 amomaxu(volatile u32* addr, u32 val)
{
	u32 res;
...
// atomic MIN signed 32-bit, returns original value
INLINE s32 amomin(volatile s32* addr, s32 val)
{
	s32 res;
...
// atomic MIN unsigned 32-bit, returns original value
INLINE u32 amominu(volatile u32* addr, u32 val)
{
	u32 res;
