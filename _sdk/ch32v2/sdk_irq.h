...
#define IRQ_CAN1_RX1	37		// CAN1 RX1 Interrupt (default weak handler CAN1_RX1_IRQn)
...
#define IRQ_USB_WU	58		// USB WakeUp from suspend through EXTI Line Interrupt (default weak handler USBWakeUp_IRQHandler)

#if CH32V2

#define IRQ_USBFS	59		// USBFS Interrupt (default weak handler USBFS_IRQHandler)
...
#define IRQ_NUM		63		// number of interrupts

#else // CH32V203

#define IRQ_ETH		61		// ETH global Interrupt (default weak handler ETH_IRQn)
#define IRQ_ETH_WU	62		// ETH WakeUp Interrupt (default weak handler ETHWakeUp_IRQn)
#define IRQ_BB		63		// BLE BB global Interrupt (default weak handler BB_IRQn)
#define IRQ_LLE		64		// BLE LLE global Interrupt (default weak handler LLE_IRQn)
#define IRQ_TIM5	65		// TIM5 global Interrupt (default weak handler TIM5_IRQn)
#define IRQ_USART4	66		// USART4 global Interrupt (default weak handler USART4_IRQn)
#define IRQ_DMA1_CH8	67		// DMA1 Channel 8 global Interrupt (default weak handler DMA1_Channel8_IRQn)
#define IRQ_OSC32K_CAL	68		// OSC32K global Interrupt (default weak handler OSC32KCal_IRQn)
#define IRQ_OSC32K_WU	69		// OSC32K WakeUp Interrupt (default weak handler OSCWakeUp_IRQn)
#define IRQ_NUM		70		// number of interrupts

#endif // CH32V203

#else // CH32V3

#define IRQ_TIM8_BRK	59		// TIM8 Break Interrupt (default weak handler TIM8_BRK_IRQHandler)
#define IRQ_TIM8_UP	60		// TIM8 Update Interrupt (default weak handler TIM8_UP_IRQHandler)
#define IRQ_TIM8_TRG	61		// TIM8 Trigger and Commutation Interrupt (default weak handler TIM8_TRG_COM_IRQHandler)
#define IRQ_TIM8_CC	62		// TIM8 Capture Compare Interrupt (default weak handler TIM8_CC_IRQHandler)
#define IRQ_RNG		63		// RNG global Interrupt (default weak handler RNG_IRQHandler)
// 64
#define IRQ_SDIO	65		// SDIO global Interrupt (default weak handler SDIO_IRQHandler)
#define IRQ_TIM5	66		// TIM5 global Interrupt (default weak handler TIM5_IRQHandler)
#define IRQ_SPI3	67		// SPI3 global Interrupt (default weak handler SPI3_IRQHandler)
#define IRQ_USART4	68		// USART4 global Interrupt (default weak handler USART4_IRQHandler)
#define IRQ_USART5	69		// USART5 global Interrupt (default weak handler USART5_IRQHandler)
#define IRQ_TIM6	70		// TIM6 global Interrupt (default weak handler TIM6_IRQHandler)
#define IRQ_TIM7	71		// TIM7 global Interrupt (default weak handler TIM7_IRQHandler)
#define IRQ_DMA2_CH1	72		// DMA2 Channel 1 global Interrupt (default weak handler DMA2_Channel1_IRQHandler)
#define IRQ_DMA2_CH2	73		// DMA2 Channel 2 global Interrupt (default weak handler DMA2_Channel2_IRQHandler)
#define IRQ_DMA2_CH3	74		// DMA2 Channel 3 global Interrupt (default weak handler DMA2_Channel3_IRQHandler)
#define IRQ_DMA2_CH4	75		// DMA2 Channel 4 global Interrupt (default weak handler DMA2_Channel4_IRQHandler)
#define IRQ_DMA2_CH5	76		// DMA2 Channel 5 global Interrupt (default weak handler DMA2_Channel5_IRQHandler)
#define IRQ_ETH		77		// ETH global Interrupt (default weak handler ETH_IRQn)
#define IRQ_ETH_WU	78		// ETH WakeUp Interrupt (default weak handler ETH_WKUP_IRQn)
#define IRQ_CAN2_TX	79		// CAN2 TX Interrupts (default weak handler CAN2_TX_IRQn)
#define IRQ_CAN2_RX0	80		// CAN2 RX0 Interrupts (default weak handler CAN2_RX0_IRQn)
#define IRQ_CAN2_RX1	81		// CAN2 RX1 Interrupt (default weak handler CAN2_RX1_IRQn)
#define IRQ_CAN2_SCE	82		// CAN2 SCE Interrupt (default weak handler CAN2_RX0_IRQn)
#define IRQ_USBFS	83		// USBFS global Interrupt (default weak handler USBFS_IRQHandler)
#define IRQ_USBHS_WU	84		// USBHS WakeUp Interrupt (default weak handler USBHSWakeup_IRQn)
#define IRQ_USBHS	85		// USBHS global Interrupt (default weak handler USBHS_IRQn)
#define IRQ_DVP		86		// DVP global Interrupt (default weak handler DVP_IRQn)
#define IRQ_USART6	87		// USART6 global Interrupt (default weak handler USART6_IRQHandler)
#define IRQ_USART7	88		// USART7 global Interrupt (default weak handler USART7_IRQHandler)
#define IRQ_USART8	89		// USART8 global Interrupt (default weak handler USART8_IRQHandler)
#define IRQ_TIM9_BRK	90		// TIM9 Break Interrupt (default weak handler TIM9_BRK_IRQHandler)
#define IRQ_TIM9_UP	91		// TIM9 Update Interrupt (default weak handler TIM9_UP_IRQHandler)
#define IRQ_TIM9_TRG	92		// TIM9 Trigger and Commutation Interrupt (default weak handler TIM9_TRG_COM_IRQHandler)
#define IRQ_TIM9_CC	93		// TIM9 Capture Compare Interrupt (default weak handler TIM9_CC_IRQHandler)
#define IRQ_TIM10_BRK	94		// TIM10 Break Interrupt (default weak handler TIM10_BRK_IRQHandler)
#define IRQ_TIM10_UP	95		// TIM10 Update Interrupt (default weak handler TIM10_UP_IRQHandler)
#define IRQ_TIM10_TRG	96		// TIM10 Trigger and Commutation Interrupt (default weak handler TIM10_TRG_COM_IRQHandler)
#define IRQ_TIM10_CC	97		// TIM10 Capture Compare Interrupt (default weak handler TIM10_CC_IRQHandler)
#define IRQ_DMA2_CH6	98		// DMA2 Channel 6 global Interrupt (default weak handler DMA2_Channel6_IRQHandler)
#define IRQ_DMA2_CH7	99		// DMA2 Channel 7 global Interrupt (default weak handler DMA2_Channel7_IRQHandler)
#define IRQ_DMA2_CH8	100		// DMA2 Channel 8 global Interrupt (default weak handler DMA2_Channel8_IRQHandler)
#define IRQ_DMA2_CH9	101		// DMA2 Channel 9 global Interrupt (default weak handler DMA2_Channel9_IRQHandler)
#define IRQ_DMA2_CH10	102		// DMA2 Channel 10 global Interrupt (default weak handler DMA2_Channel10_IRQHandler)
#define IRQ_DMA2_CH11	103		// DMA2 Channel 11 global Interrupt (default weak handler DMA2_Channel11_IRQHandler)
#define IRQ_NUM		104		// number of interrupts
...
#define EXTI_LINE18	18		// External interrupt line 18 Connected to the USBD/USBFS OTG
#define EXTI_LINE19	19		// External interrupt line 19 Connected to the Ethernet Wakeup event
#define EXTI_LINE20	20		// External interrupt line 20 Connected to the USBHS Wakeup event
