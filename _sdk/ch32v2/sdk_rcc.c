...
{
	// Preset long flash wait state
//	Flash_Latency(2);	// 2 wait states
...
/*
	...
	if (RCC_GetFreq(CLK_HCLK) >= 50000000)
		Flash_Latency(0);	// 0 wait state
	else if (RCC_GetFreq(CLK_HCLK) >= 25000000)
		Flash_Latency(1);	// 1 wait state
*/
}
...
void SystemInit(void)
{
	...
	u32 mask =
		...
		RCC_AHBCLK_DMA1 |
#endif
#if !defined(ENABLE_DMA2) || ENABLE_DMA2	// DMA2 module enable
		RCC_AHBCLK_DMA2 |
#endif
		...
		RCC_AHBCLK_CRC |
#endif
#if !defined(ENABLE_FSMC) || ENABLE_FSMC	// FSMC module enable
		RCC_AHBCLK_FSMC |
#endif
#if !defined(ENABLE_RNG) || ENABLE_RNG		// RNG module enable
		RCC_AHBCLK_RNG |
#endif
#if !defined(ENABLE_SDIO) || ENABLE_SDIO	// SDIO module enable
		RCC_AHBCLK_SDIO |
#endif
#if !defined(ENABLE_USBHS) || ENABLE_USBHS	// USBHS module enable
		RCC_AHBCLK_USBHS |
#endif
#if !defined(ENABLE_USBOTG) || ENABLE_USBOTG	// USBOTG module enable
		RCC_AHBCLK_USBOTG |
#endif
#if !defined(ENABLE_DVP) || ENABLE_DVP		// DVP module enable
		RCC_AHBCLK_DVP |
#endif
#if !defined(ENABLE_ETHMAC) || ENABLE_ETHMAC	// ETHMAC module enable
		RCC_AHBCLK_ETHMAC |
#endif
#if !defined(ENABLE_ETHMACTX) || ENABLE_ETHMACTX // ETHMACTX module enable
		RCC_AHBCLK_ETHMACTX |
#endif
#if !defined(ENABLE_ETHMACRX) || ENABLE_ETHMACRX // ETHMACRX module enable
		RCC_AHBCLK_ETHMACRX |
#endif
#if !defined(ENABLE_BLEC) || ENABLE_BLEC	// BLEC module enable
		RCC_AHBCLK_BLEC |
#endif
#if !defined(ENABLE_BLES) || ENABLE_BLES	// BLES module enable
		RCC_AHBCLK_BLES |
#endif
		0;
	...
	mask =
		...
		RCC_APB2CLK_PD |
#endif
#if !defined(ENABLE_PE) || ENABLE_PE		// PE port enable
		RCC_APB2CLK_PE |
#endif
#if !defined(ENABLE_ADC1) || ENABLE_ADC1	// ADC1 module enable
		RCC_APB2CLK_ADC1 |
#endif
#if !defined(ENABLE_ADC2) || ENABLE_ADC2	// ADC2 module enable
		RCC_APB2CLK_ADC2 |
#endif
		...
		RCC_APB2CLK_SPI1 |
#endif
#if !defined(ENABLE_TIM8) || ENABLE_TIM8	// TIM8 module enable
		RCC_APB2CLK_TIM8 |
#endif
#if !defined(ENABLE_USART1) || ENABLE_USART1	// USART1 module enable
		RCC_APB2CLK_USART1 |
#endif
#if !defined(ENABLE_TIM9) || ENABLE_TIM9	// TIM9 module enable
		RCC_APB2CLK_TIM9 |
#endif
#if !defined(ENABLE_TIM10) || ENABLE_TIM10	// TIM10 module enable
		RCC_APB2CLK_TIM10 |
#endif
		0;
	...
	mask =
		...
		RCC_APB1CLK_TIM4 |
#endif
#if !defined(ENABLE_TIM5) || ENABLE_TIM5	// TIM5 module enable
		RCC_APB1CLK_TIM5 |
#endif
#if !defined(ENABLE_TIM6) || ENABLE_TIM6	// TIM6 module enable
		RCC_APB1CLK_TIM6 |
#endif
#if !defined(ENABLE_TIM7) || ENABLE_TIM7	// TIM7 module enable
		RCC_APB1CLK_TIM7 |
#endif
#if !defined(ENABLE_USART6) || ENABLE_USART6	// USART6 module enable
		RCC_APB1CLK_USART6 |
#endif
#if !defined(ENABLE_USART7) || ENABLE_USART7	// USART7 module enable
		RCC_APB1CLK_USART7 |
#endif
#if !defined(ENABLE_USART8) || ENABLE_USART8	// USART8 module enable
		RCC_APB1CLK_USART8 |
#endif
		...
		RCC_APB1CLK_SPI2 |
#endif
#if !defined(ENABLE_SPI3) || ENABLE_SPI3	// SPI3 module enable
		RCC_APB1CLK_SPI3 |
#endif
		...
		RCC_APB1CLK_USART4 |
#endif
#if !defined(ENABLE_USART5) || ENABLE_USART5	// USART5 module enable
		RCC_APB1CLK_USART5 |
#endif
		...
		RCC_APB1CLK_I2C2 |
#endif
#if !defined(ENABLE_USBD) || ENABLE_USBD	// USBD module enable
		RCC_APB1CLK_USBD |
#endif
#if !defined(ENABLE_CAN1) || ENABLE_CAN1	// CAN1 module enable
		RCC_APB1CLK_CAN1 |
#endif
#if !defined(ENABLE_CAN2) || ENABLE_CAN2	// CAN2 module enable
		RCC_APB1CLK_CAN2 |
#endif
