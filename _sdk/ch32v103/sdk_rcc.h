...
#ifndef HSE_VALUE
#define HSE_VALUE	16000000	// frequency of HSE external oscillator 16MHz (should be 4..16 MHz)
#endif
...
#ifndef ADCCLK_DIV
#define ADCCLK_DIV	6		// ADC clock divider: 2, 4, 6, 8 (max. 14 MHz)
#endif
...
#define RCC_USBPRE_DIV1		1	// USB PLL 1-division for PLLCLK=48MHz
#define RCC_USBPRE_DIV15	0	// USB PLL 1.5-division for PLLCLK=72MHz
...
#define RCC_AHBCLK_FLASH	B4	// FLASH clock mask
...
#define RCC_APB1CLK_USBPD	B23	// USBPD module clock mask
...
// Enable/Disable HSI high-speed internal oscillator MHz (default enabled)
...
//  Oscillator frequency 8MHz can be adjusted by 20KHz per step.
...
INLINE void RCC_USBPLLDiv(int div) { RCC->CFGR0 = (RCC->CFGR0 & ~(1 << 22)) | (div << 22); }
...
// USBPD module reset ON/OFF/Reset
INLINE void RCC_USBPDResetOn(void) { RCC->APB1PRSTR |= B23; cb(); }
INLINE void RCC_USBPDResetOff(void) { RCC->APB1PRSTR &= ~B23; cb(); }
...
// Flash memory module clock Enable/Disable
INLINE void RCC_FlashClkEnable(void) { RCC->AHBPCENR |= B4; cb(); }
INLINE void RCC_FlashClkDisable(void) { RCC->AHBPCENR &= ~B4; cb(); }
...
// USBPD module clock Enable/Disable
INLINE void RCC_USBPDClkEnable(void) { RCC->APB1PCENR |= B23; cb(); }
INLINE void RCC_USBPDClkDisable(void) { RCC->APB1PCENR &= ~B23; cb(); }
