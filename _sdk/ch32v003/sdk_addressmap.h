...
#define I2C1_BASE		(APB1PERIPH_BASE + 0x5400)	// I2C 0x40005400
...
// pointer to vendor configuration of HSI trim byte 0..31 (0xff = not set)
#define VENDOR_HSI_TRIM		0x1FFFF7D4
