...
#define IRQ_TIM2_UP	38		// TIM2 Update interrupt (default weak handler TIM2_UP_IRQHandler)
#define IRQ_USART2	39		// USART2 global Interrupt (default weak handler USART2_IRQHandler)
#define IRQ_EXTI15_8	40		// External Line[15:8] Interrupts (default weak handler EXTI15_8_IRQHandler)
#define IRQ_EXTI25_16	41		// External Line[25:16] Interrupts (default weak handler EXTI25_16_IRQHandler)
#define IRQ_USART3	42		// USART3 global Interrupt (default weak handler USART3_IRQHandler)
#define IRQ_USART4	43		// USART4 global Interrupt (default weak handler USART4_IRQHandler)
#define IRQ_DMA1_CH8	44		// DMA1 Channel 8 global Interrupt (default weak handler DMA1_Channel8_IRQHandler)
#define IRQ_USBFS	45		// USBFS Host/Device global Interrupt (default weak handler USBFS_IRQHandler)
#define IRQ_USBFS_WU	46		// USBFS Host/Device WakeUp Interrupt (default weak handler USBFSWakeUp_IRQHandler)
#define IRQ_PIOC	47		// PIOC global Interrupt (default weak handler PIOC_IRQHandler)
#define IRQ_OPA		48		// OPA global Interrupt (default weak handler OPA_IRQHandler)
#define IRQ_USBPD	49		// USBPD global Interrupt (default weak handler USBPD_IRQHandler)
#define IRQ_USBPD_WU	50		// USBPD WakeUp Interrupt (default weak handler USBPDWakeUp_IRQHandler)
#define IRQ_TIM2_CC	51		// TIM2 Capture Compare Interrupt (default weak handler TIM2_CC_IRQHandler)
#define IRQ_TIM2_TRG	52		// TIM2 Trigger and Commutation Interrupt (default weak handler TIM2_TRG_COM_IRQHandler)
#define IRQ_TIM2_BRK	53		// TIM2 Break Interrupt (default weak handler TIM2_BRK_IRQHandler)
#define IRQ_TIM3	54		// TIM3 global Interrupt (default weak handler TIM3_IRQHandler)

#define IRQ_NUM		55		// number of interrupts
...
#define EXTI_LINE16	16		// External interrupt line 16
#define EXTI_LINE17	17		// External interrupt line 17
#define EXTI_LINE18	18		// External interrupt line 18
#define EXTI_LINE19	19		// External interrupt line 19
#define EXTI_LINE20	20		// External interrupt line 20
#define EXTI_LINE21	21		// External interrupt line 21
#define EXTI_LINE22	22		// External interrupt line 22
#define EXTI_LINE23	23		// External interrupt line 23
#define EXTI_LINE24	24		// External interrupt line 24 Connected to the PC18 (SDI on)
#define EXTI_LINE25	25		// External interrupt line 25 Connected to the PC19 (SDI on)
#define EXTI_LINE26	26		// External interrupt line 26 Connected to the PVD Output
#define EXTI_LINE27	27		// External interrupt line 27 Connected to the Auto Wake-up event
#define EXTI_LINE28	28		// External interrupt line 28 Connected to the the USBFS Wake-up event
#define EXTI_LINE29	29		// External interrupt line 29 Connected to the the USB PD Wake-up event
