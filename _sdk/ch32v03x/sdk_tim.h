...
#define TIM3	((TIM_t*)TIM3_BASE)	// 0x40000400
...
// Enable/Disable channel 1 and 2 alternate function (default disable)
INLINE void TIMx_AFCH12Enable(TIM_t* tim) { tim->SPEC |= B0; }
INLINE void TIM1_AFCH12Enable(void) { TIMx_AFCH12Enable(TIM1); }
INLINE void TIM2_AFCH12Enable(void) { TIMx_AFCH12Enable(TIM2); }
INLINE void TIM3_AFCH12Enable(void) { TIMx_AFCH12Enable(TIM3); }

INLINE void TIMx_AFCH12Disable(TIM_t* tim) { tim->SPEC &= ~B0; }
INLINE void TIM1_AFCH12Disable(void) { TIMx_AFCH12Disable(TIM1); }
INLINE void TIM2_AFCH12Disable(void) { TIMx_AFCH12Disable(TIM2); }
INLINE void TIM3_AFCH12Disable(void) { TIMx_AFCH12Disable(TIM3); }

// Enable/Disable channel 3 and 5 alternate function (default disable)
INLINE void TIMx_AFCH34Enable(TIM_t* tim) { tim->SPEC |= B1; }
INLINE void TIM1_AFCH34Enable(void) { TIMx_AFCH34Enable(TIM1); }
INLINE void TIM2_AFCH34Enable(void) { TIMx_AFCH34Enable(TIM2); }
INLINE void TIM3_AFCH34Enable(void) { TIMx_AFCH34Enable(TIM3); }

INLINE void TIMx_AFCH34Disable(TIM_t* tim) { tim->SPEC &= ~B1; }
INLINE void TIM1_AFCH34Disable(void) { TIMx_AFCH34Disable(TIM1); }
INLINE void TIM2_AFCH34Disable(void) { TIMx_AFCH34Disable(TIM2); }
INLINE void TIM3_AFCH34Disable(void) { TIMx_AFCH34Disable(TIM3); }

// Set alternate channel 1 invalid level to HIGH or LOW (default LOW)
INLINE void TIMx_AFOC1High(TIM_t* tim) { tim->SPEC |= B4; }
INLINE void TIM1_AFOC1High(void) { TIMx_AFOC1High(TIM1); }
INLINE void TIM2_AFOC1High(void) { TIMx_AFOC1High(TIM2); }
INLINE void TIM3_AFOC1High(void) { TIMx_AFOC1High(TIM3); }

INLINE void TIMx_AFOC1Low(TIM_t* tim) { tim->SPEC &= ~B4; }
INLINE void TIM1_AFOC1Low(void) { TIMx_AFOC1Low(TIM1); }
INLINE void TIM2_AFOC1Low(void) { TIMx_AFOC1Low(TIM2); }
INLINE void TIM3_AFOC1Low(void) { TIMx_AFOC1Low(TIM3); }

// Set alternate channel 2 invalid level to HIGH or LOW (default LOW)
INLINE void TIMx_AFOC2High(TIM_t* tim) { tim->SPEC |= B5; }
INLINE void TIM1_AFOC2High(void) { TIMx_AFOC2High(TIM1); }
INLINE void TIM2_AFOC2High(void) { TIMx_AFOC2High(TIM2); }
INLINE void TIM3_AFOC2High(void) { TIMx_AFOC2High(TIM3); }

INLINE void TIMx_AFOC2Low(TIM_t* tim) { tim->SPEC &= ~B5; }
INLINE void TIM1_AFOC2Low(void) { TIMx_AFOC2Low(TIM1); }
INLINE void TIM2_AFOC2Low(void) { TIMx_AFOC2Low(TIM2); }
INLINE void TIM3_AFOC2Low(void) { TIMx_AFOC2Low(TIM3); }

// Set alternate channel 3 invalid level to HIGH or LOW (default LOW)
INLINE void TIMx_AFOC3High(TIM_t* tim) { tim->SPEC |= B6; }
INLINE void TIM1_AFOC3High(void) { TIMx_AFOC3High(TIM1); }
INLINE void TIM2_AFOC3High(void) { TIMx_AFOC3High(TIM2); }
INLINE void TIM3_AFOC3High(void) { TIMx_AFOC3High(TIM3); }

INLINE void TIMx_AFOC3Low(TIM_t* tim) { tim->SPEC &= ~B6; }
INLINE void TIM1_AFOC3Low(void) { TIMx_AFOC3Low(TIM1); }
INLINE void TIM2_AFOC3Low(void) { TIMx_AFOC3Low(TIM2); }
INLINE void TIM3_AFOC3Low(void) { TIMx_AFOC3Low(TIM3); }

// Set alternate channel 4 invalid level to HIGH or LOW (default LOW)
INLINE void TIMx_AFOC4High(TIM_t* tim) { tim->SPEC |= B7; }
INLINE void TIM1_AFOC4High(void) { TIMx_AFOC4High(TIM1); }
INLINE void TIM2_AFOC4High(void) { TIMx_AFOC4High(TIM2); }
INLINE void TIM3_AFOC4High(void) { TIMx_AFOC4High(TIM3); }

INLINE void TIMx_AFOC4Low(TIM_t* tim) { tim->SPEC &= ~B7; }
INLINE void TIM1_AFOC4Low(void) { TIMx_AFOC4Low(TIM1); }
INLINE void TIM2_AFOC4Low(void) { TIMx_AFOC4Low(TIM2); }
INLINE void TIM3_AFOC4Low(void) { TIMx_AFOC4Low(TIM3); }

// Get valid channel indication
INLINE Bool TIMx_IsInvalid(TIM_t* tim) { return (tim->SPEC & B15) != 0; }
INLINE Bool TIM1_IsInvalid(void) { return TIMx_IsInvalid(TIM1); }
INLINE Bool TIM2_IsInvalid(void) { return TIMx_IsInvalid(TIM2); }
INLINE Bool TIM3_IsInvalid(void) { return TIMx_IsInvalid(TIM3); }
