...
//
// ****************************************************************************
// To use IWDG (Independent Watchdog):
...
// - Wait if IWDG_PrescBusy(), set IWDG prescaler with IWDG_SetPresc(). ... IWDG uses clock source HSI 48MHz/1024 = 47kHz
// - Wait if IWDG_ReloadBusy(), set reload register with IWDG_SetReload(). ... Max. wait time is 22 seconds.
...
// IWDG prescaler
#define IWDG_PRESC_4	0	// IWDG prescaler 1/4 ... clock 12kHz
#define IWDG_PRESC_8	1	// IWDG prescaler 1/8 ... clock 6kHz
#define IWDG_PRESC_16	2	// IWDG prescaler 1/16 ... clock 3kHz
#define IWDG_PRESC_32	3	// IWDG prescaler 1/32 ... clock 1.5kHz
#define IWDG_PRESC_64	4	// IWDG prescaler 1/64 ... clock 730Hz
#define IWDG_PRESC_128	5	// IWDG prescaler 1/128 ... clock 366Hz
#define IWDG_PRESC_256	6	// IWDG prescaler 1/256 ... clock 183Hz
...
// set/get IWDG prescaler IWDG_PRESC_* (time base timer is HSI 48MHz/1024 = 47kHz = LSI_VALUE; result clock is 12kHz..183Hz)
...
// set/get IWDG reload value 0x000..0xFFF (= 0..4095; max. interval is 4096/183 = 22 seconds)
// - Write must be enabled first, with IWDG_EnableWrite()
