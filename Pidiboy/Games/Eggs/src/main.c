...
void OpenDraw()
{
	...
	// draw menu
	DrawTextCond6("Press key to start:", 0, 2*6, COL_WHITE);

	DrawTextCond6("LEFT .... Play eggs", 0, 4*6, COL_WHITE);
	DrawTextCond6("RIGHT ... Play hens", 0, 5*6, COL_WHITE);
	DrawTextCond6("DOWN .... 2 players", 0, 6*6, COL_WHITE);
	DrawTextCond6("UP ...... Demo", 0, 7*6, COL_WHITE);
	DrawTextCond6("Y ....... Quit", 0, 9*6, COL_WHITE);
