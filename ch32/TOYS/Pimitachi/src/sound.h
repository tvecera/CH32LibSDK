...
#define AUDIO_GPIO	PC4		// audio output

// Timer divider, frequency of time base is 50000000/50 = 1000000 = 1 MHz
#define SND_TIM_DIV	HCLK_PER_US	// timer divider

// note length in [ms] (step 1/60 sec)
#define NOTE_LEN1DOT	(96*16)		// 1.
#define NOTE_LEN1	(64*16)		// 1
#define NOTE_LEN2DOT	(48*16)		// 1/2.
#define NOTE_LEN2	(32*16)		// 1/2
#define NOTE_LEN4DOT	(24*16)		// 1/4.
#define NOTE_LEN4	(16*16)		// 1/4
#define NOTE_LEN8DOT	(12*16)		// 1/8.
#define NOTE_LEN8	(8*16)		// 1/8
#define NOTE_LEN16DOT	(6*16)		// 1/16.
#define NOTE_LEN16	(4*16)		// 1/16
#define NOTE_LEN32DOT	(3*16)		// 1/32.
#define NOTE_LEN32	(2*16)		// 1/32
#define NOTE_LEN64DOT	(1*16+8)	// 1/64.
#define NOTE_LEN64	(1*16)		// 1/64
...
// tone from melody
typedef struct {
	u16	len;		// length in [ms] (use constant NOTE_LEN*), use NOTE_STOP to mark end of melody
	u16	div;		// divider (use macro SND_GET_DIV(hz01) or constant NOTE_*)
} sTone;
