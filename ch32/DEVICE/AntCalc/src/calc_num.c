...
sNum NumLnX2, NumLnMem, NumLnTmp, NumLnTmp2, NumLnTmp3;
...
// power (num <- num1 ^ num2) ... uses NumMulTemp1, NumMulTemp2, NumMulTemp3, NumMulTemp4, NumMulTemp5, NumLnX2, NumLnMem, NumLnTmp, NumLnTmp2
void NumPow(sNum* num, const sNum* num1, const sNum* num2)
{
	...
	NumCopy(&NumLnTmp2, num1);
	NumLn(&NumLnTmp2);

	// multiply by exponent
	NumMul(num, &NumLnTmp2, num2);

	// back to exponent
	NumExp(num);
}

// root (num <- num1 root num2) ... uses NumMulTemp1, NumMulTemp2, NumMulTemp3, NumMulTemp4, NumMulTemp5, NumLnX2, NumLnMem, NumLnTmp, NumLnTmp2, NumLnTmp3
void NumRoot(sNum* num, const sNum* num1, const sNum* num2)
{
	NumDiv(&NumLnTmp3, &Const1, num2);
	NumPow(num, num1, &NumLnTmp3);
}
