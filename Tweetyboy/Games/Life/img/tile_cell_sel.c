...
// image pitch: 6 bytes
const u16 ImgTileCellSel_Pal[256] __attribute__ ((aligned(4))) = {
...
const u8 ImgTileCellSel[36] __attribute__ ((aligned(4))) = {
	0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xFF, 0xFF, 0xFF, 0xFF, 0xE0, 0xE0, 0xFF, 0xE0, 0xE0, 
	0xFF, 0xE0, 0xE0, 0xFF, 0xE0, 0xE0, 0xFF, 0xE0, 0xE0, 0xFF, 0xFF, 0xFF, 0xFF, 0xE0, 0xE0, 0xE0, 
	0xE0, 0xE0, 0xE0, 0xE0, 
};
