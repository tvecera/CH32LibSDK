...
// image pitch: 6 bytes
const u16 ImgTileCell_Pal[256] __attribute__ ((aligned(4))) = {
...
const u8 ImgTileCell[36] __attribute__ ((aligned(4))) = {
	0x0D, 0x98, 0x98, 0x98, 0x98, 0x98, 0x98, 0x0D, 0xF8, 0xF8, 0xF8, 0x0D, 0x98, 0xF8, 0xF8, 0xF8, 
	0xF8, 0xF8, 0x98, 0xF8, 0xF8, 0xE0, 0xF8, 0xF8, 0x98, 0xF8, 0xF8, 0xF8, 0xF8, 0xF8, 0x98, 0x0D, 
	0xF8, 0xF8, 0xF8, 0x0D, 
};
