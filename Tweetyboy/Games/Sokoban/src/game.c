...
// tile color
const u8 ToleCol[TILE_NUM] = {
	COL_BLACK,	// EMPTY = 0,	// 0: empty (grass)
	COL_RED,	// WALL,	// 1: wall
	COL_GRAY,	// FLOOR,	// 2: floor
	COL_LTBLUE,	// MARK,	// 3: mark
	COL_YELLOW,	// CRATE,	// 4: crate
	COL_GREEN,	// FULL,	// 5: full crate (crate on mark)
	COL_WHITE,	// FACE,	// 6: face
	COL_CYAN,	// FACE_MARK,	// 7: face on mark
};
...
void DispTile(u8 x, u8 y)
{
	...
	DrawMonoImgBg(ImgTiles + tile*TILESIZE, x*TILESIZE+MAPX, y*TILESIZE+MAPY,
		TILESIZE, TILESIZE, 1, ToleCol[tile], COL_BLACK);
}	
